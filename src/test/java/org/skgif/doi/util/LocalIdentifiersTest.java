...
class LocalIdentifiersTest {
    ...
    private static Stream<Arguments> toDoiCases() {
        return Stream.of(
                Arguments.of("bare DOI returns unchanged", "10.15151/esrf-es-2210534378",
                        "10.15151/esrf-es-2210534378"),
                Arguments.of("canonical full local identifier strips base URL",
                ...
                // "https://doi.org/...".
                Arguments.of("Vert.x-collapsed single-slash form strips base URL",
                        "https:/doi.org/10.15151/esrf-es-2210534378", "10.15151/esrf-es-2210534378"),
                Arguments.of("unrelated value passes through unchanged", "not-a-doi-or-url", "not-a-doi-or-url"),
                ...
                Arguments.of("different scheme is not tolerated", "http://doi.org/10.15151/esrf-es-2210534378",
