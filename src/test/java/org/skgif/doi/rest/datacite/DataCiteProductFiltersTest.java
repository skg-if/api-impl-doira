...
final class DataCiteProductFiltersTest {
    ...
    static Stream<Arguments> equalityCases() {
        ...
        return Stream.of(
                arguments("returns null for null input", null, null),
                arguments("returns null for blank input", "  ", null),
                arguments("family name searches both creators and contributors",
                        "contributions.by.family_name:Choiniere",
                        "(creators.familyName:\"Choiniere\" OR contributors.familyName:\"Choiniere\")"),
                arguments("escapes quotes in family name", "contributions.by.family_name:O\"Brien",
                        "(creators.familyName:\"O\\\"Brien\" OR contributors.familyName:\"O\\\"Brien\")"),
                arguments("combines multiple filters with and",
                ...
                arguments("value containing commas is not misparsed as separate segments",
                        "contributions.declared_affiliations.name:" + esrfAddress, "(creators.affiliation.name:\"" +
                                esrfAddress + "\" OR contributors.affiliation.name:\"" + esrfAddress + "\")"),
                arguments("value containing commas followed by another real filter",
                ...
                arguments("product type research software ors its resource types", "product_type:research software",
                ...
                arguments("product type unrecognized value has no match", "product_type:bogus", "doi:\"__no_match__\""),
                ...
                arguments("product type award is not a valid product type, no match", "product_type:award",
                        "doi:\"__no_match__\""),
                arguments("identifiers scheme is a no-op for doi", "identifiers.scheme:doi", null),
                ...
                arguments("identifiers scheme zero match for other scheme", "identifiers.scheme:pmid",
                        "doi:\"__no_match__\""),
                arguments("by local identifier searches both roles with value as-is",
                        "contributions.by.local_identifier:" + orcidUrl, "(creators.nameIdentifiers.nameIdentifier:\"" +
                                orcidUrl + "\" OR contributors.nameIdentifiers.nameIdentifier:\"" + orcidUrl + "\")"),
                arguments("by identifiers id adds orcid prefix and searches both roles",
                ...
                arguments("by identifiers scheme is a no-op for orcid", "contributions.by.identifiers.scheme:orcid",
                        null),
                arguments("by identifiers scheme zero match for other scheme",
                        "contributions.by.identifiers.scheme:isni", "doi:\"__no_match__\""),
                arguments("by given name searches both roles", "contributions.by.given_name:Jonah",
                ...
                arguments("by name searches both roles", "contributions.by.name:Wilkinson",
                        "(creators.name:\"Wilkinson\" OR contributors.name:\"Wilkinson\")"),
                arguments("declared affiliations local identifier searches both roles with value as-is",
                ...
                arguments("declared affiliations identifiers id adds ror prefix and searches both roles",
                ...
                arguments("declared affiliations identifiers scheme is a no-op for ror",
                        "contributions.declared_affiliations.identifiers.scheme:ror", null),
                arguments("declared affiliations identifiers scheme zero match for other scheme",
                        "contributions.declared_affiliations.identifiers.scheme:isni", "doi:\"__no_match__\""),
                ...
                arguments("funding grant number", "funding.grant_number:MX-2738",
                        "fundingReferences.awardNumber:\"MX-2738\""),
                arguments("cf.cites strips full doi url prefix", "cf.cites:https://doi.org/10.15151/esrf-dc-2493599001",
                        "relatedIdentifiers.relatedIdentifier:\"10.15151/esrf-dc-2493599001\""),
                arguments("cf.cited_by bare doi passes through unchanged", "cf.cited_by:10.15151/esrf-dc-2493599001",
                        "relatedIdentifiers.relatedIdentifier:\"10.15151/esrf-dc-2493599001\""));
    }
    ...
    static Stream<Arguments> exceptionCases() {
        return Stream.of(
                ...
                arguments("unsupported key throws", "funding.identifiers.id:10.3030/101095129",
                        "funding.identifiers.id"),
                arguments("malformed segment throws", "contributions.by.family_name", null));
    }
